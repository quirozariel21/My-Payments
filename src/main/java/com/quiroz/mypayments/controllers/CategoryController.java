...
public class CategoryController {
    ...
    public ResponseEntity<CategoryResponseDto> saveCategory(
            @Valid @RequestBody AddCategoryRequestDto addCategoryRequestDto) {
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully obtained the category"),
    ...
    @ApiResponses(
            value = {
                @ApiResponse(
                        responseCode = "200",
                        description = "Successfully getting the categories"),
    ...
    public ResponseEntity<SubcategoryResponseDto> saveSubcategory(
            @PathVariable Long categoryId,
            @Valid @RequestBody AddSubcategoryRequestDto requestDto) {
        return ResponseEntity.status(HttpStatus.CREATED)
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Unable to update the subcategory"),
    ...
    public ResponseEntity<SubcategoryResponseDto> updateSubcategory(
            @Valid @RequestBody UpdateSubcategoryRequestDto requestDto) {
    ...
    public ResponseEntity<Void> deleteSubcategory(
            @PathVariable Long categoryId, @PathVariable Long id) {
